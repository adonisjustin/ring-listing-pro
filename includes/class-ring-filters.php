...
public function render_filters() {
    ...
    $metal_colors = $this->get_metal_colors(); // NEW
    ...
    <div class="rsp-filters-container">
        ...
        <div class="rsp-filters-grid">
            ...
            <?php if (!empty($metal_colors)): ?>
            <div class="rsp-filter-section">
                <h5>Metal Color</h5>
                <div class="rsp-checkbox-list">
                    <?php foreach ($metal_colors as $color): ?>
                    <label class="rsp-checkbox-item">
                        <input type="checkbox" name="metal_color" value="<?php echo esc_attr($color->slug); ?>">
                        <span class="rsp-checkmark"></span>
                        <?php echo esc_html($color->name); ?>
                        <span class="rsp-count">(<?php echo $color->count; ?>)</span>
                    </label>
                    <?php endforeach; ?>
                </div>
            </div>
...
private function get_diamond_shapes() {
    ...
    private function get_metal_colors() {
    return get_terms(array(
